...
export class EditUser extends Component {
  ...
  onSaveUser = async (e) => {
    ...
    const { firstname,lastname, address,admin,status,phone,email } = user;
    await this.setState({
      validation: {
        ...validation,
        lastname: lastname !== '',
  ...
  saveUser = () => {
    ...
    const {  firstname,lastname, user,address,admin,status,phone,email,password } = this.state.user;
    ...
    return axios
      .post(
        `${settings.API_URL}bookings/updateuser/${this.state.user.id}`,
        data,
        {
          headers: authHeader(),
        },
  ...
  render() {
    ...
    const { saving, edit, loading, user, show } = this.state;
    return (
      <>
        <Modal
                    ...
                    <Form.Group id="Lastname">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          name='lastname'
                          disabled={!edit}
                          value={user.lastname || ''} required onChange={async (e) => {
                    ...
                    <Form.Group id="firstName">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          name='firstname'
                          disabled={!edit}
                          value={user.firstname || ''} required onChange={async (e) => {
                    ...
                    <Form.Group id="Lastname">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          name='email'
                          disabled={!edit}
                          value={user.email || ''} required  onChange={async (e) => {
                    ...
                    <Form.Group id="phone">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          name='phone'
                          disabled={!edit}
                          value={user.phone || ''} required onChange={async (e) => {
                    ...
                    <Form.Group id="address">
                      ...
                      <InputGroup>
                        ...
                        <Input
                          ...
                          name='address'
                          disabled={!edit}
                          value={user.address || ''} required  onChange={async (e) => {
