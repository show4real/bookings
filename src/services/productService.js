...
export function getGames(data) {
    ...
    return fetch(`${settings.API_URL}allgames`, requestOptions).then(authService.handleResponse);
}
...
export function addGame(data) {
    ...
    return fetch(`${settings.API_URL}games`, requestOptions).then(authService.handleResponse);
}
...
export function editGame(data) {
    ...
    return fetch(`${settings.API_URL}games/${data.id}`, requestOptions).then(authService.handleResponse);
}
...
export function deleteGame(id) {
    ...
    return fetch(`${settings.API_URL}delete-games/${id}`, requestOptions).then(authService.handleResponse);
}
