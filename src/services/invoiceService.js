...
export function getBookings(data) {
  ...
  return fetch(`${settings.API_URL}all-bookings`, requestOptions).then(
    authService.handleResponse
  );
}
...
export function getBooking(id) {
  const requestOptions = {
    ...
    return fetch(`${settings.API_URL}bookings/${id}`, requestOptions).then(
      authService.handleResponse
    );
}
...
export function deleteBooking(id) {
  ...
  return fetch(`${settings.API_URL}deletebooking/${id}`, requestOptions).then(
    authService.handleResponse
  );
}